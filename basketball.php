...
$news_sql = "SELECT * FROM tbl_news WHERE category= 'Basketball' LIMIT 3"; 
...
$roaster_sql = "SELECT dp,fname,sname,Position ,DOB,TIMESTAMPDIFF(YEAR,DOB,curdate()) as age FROM tbl_teamroaster WHERE sport= '1' LIMIT 16 "; 
