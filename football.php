...
$news_sql = "SELECT * FROM tbl_news WHERE category= 'football' LIMIT 3"; 
          ...
          <article class="card" style="height:400px; width: 31.8%;margin: 6px;" >
           <img height="120" width="50" src="<?php echo $row['image']?>"/>
            <div>
              ...
              <h3>
                <a style="color: #3CB371" href="article.html"><?php echo $row['heading']?></a>
              </h3>
...
$roaster_sql = "SELECT dp,fname,sname,Position ,DOB,TIMESTAMPDIFF(YEAR,DOB,curdate()) as age FROM tbl_teamroaster WHERE sport= '2'AND team = $teamname LIMIT 16 "; 
