...
<div class="header">
  ...
  <?php
  //Fetching individual article from the database
  if(isset($_GET['attrib'])){
    $index = $_GET['attrib'];
  }
 
  $single_news_query = mysqli_query($conn,"SELECT * FROM tbl_news WHERE id='".$index."'");
  
  $result = mysqli_fetch_assoc($single_news_query);
  ?>
<div class='card'style='margin:1em;'>
<h2 style="font-size:2em;">
   <?php echo $result['heading']?>
 </h2>
<img height="500" src="<?php echo $result['image']?>" />

<div >
<div class="category category-sports" style="font-size: 0.7em;"><?php echo $result['category']?></div>
  
<p style="font-size: 0.9em;" ><?php echo $result['shortcut_status']?></p>
<p style="font-size: 0.9em;" ><?php echo $result['status']?></p>
 <p style="font-size: 0.9em;"><?php echo $result['date']?></p>
 </div>
</div>
</body>
</html>