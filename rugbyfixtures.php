 ...
 <div class="header">
    <div class="container">
      <div class="header-left">
         <a href="#"><i class="fas fa-football-ball"></i>Rugby<span>Just Do it</span></a></a>
      </div>
...
<center><h3>Rugby Results & Fixtures</h3></center>

 <?php
  $query = "SELECT HomeTeam.teamname as TeamH, AwayTeam.teamname as TeamA, M.homescore, M.awayscore,M.date,M.time,HomeTeam.teamlogo as Hlogo,AwayTeam.teamlogo as Alogo from tbl_match as M join tbl_team as HomeTeam on M.hometeam = hometeam.id join tbl_team as AwayTeam on M.awayteam = awayteam.id WHERE  M.sport = '4' LIMIT 10";
