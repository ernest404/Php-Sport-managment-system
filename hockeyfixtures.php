...
<center><h3>Hockey Scores & Fixtures</h3></center>

 <?php
  $query = "SELECT HomeTeam.teamname as TeamH, AwayTeam.teamname as TeamA, M.homescore, M.awayscore,M.date,M.time,HomeTeam.teamlogo as Hlogo,AwayTeam.teamlogo as Alogo from tbl_match as M join tbl_team as HomeTeam on M.hometeam = hometeam.id join tbl_team as AwayTeam on M.awayteam = awayteam.id WHERE  M.sport = '3' LIMIT 10";
