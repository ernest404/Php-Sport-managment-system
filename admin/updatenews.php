...
<div id="news">
 <h2>UPDATE STATUS</h2>
 <form method="post" action="admin_news_process.php" enctype="multipart/form-data">
...
?>
 ...
 <input type="text" name="heading" class="inputs" placeholder="enter news heading"/>
 <h4 class="fix form_h4">Headline  :</h4>
 <textarea name="shortcut_status" cols="40" rows="3"></textarea>
 <h4 class="fix form_h4">News  :</h4>
