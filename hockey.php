...
<body >
   ...
   <div class="header">
    <div class="container">
      <div class="header-left">
         <a href="index.html"><i class="fas fa-home"></i>Home of Hockey<span>Just Do it</span></a>
      </div>
  ...
  <div class="header-nav">
    ...
    <li><a href="hockeyfixtures.php">Scores&Fixtures</a></li>
    <li><a href="hockeytable.php">Tables</a></li>
...
$news_sql = "SELECT * FROM tbl_news WHERE category= 'Hockey' LIMIT 3"; 
...
$roaster_sql = "SELECT dp,fname,sname,Position ,DOB,TIMESTAMPDIFF(YEAR,DOB,curdate()) as age FROM tbl_teamroaster WHERE sport= '3'AND team = $teamname LIMIT 16 "; 
...
<?php
  $query = "SELECT * FROM tbl_scorers INNER JOIN tbl_teamroaster ON tbl_scorers.name=tbl_teamroaster.ID WHERE tbl_teamroaster.sport = '3' ORDER by score DESC, ts ASC LIMIT 10";
  $result = mysqli_query($conn,$query) or die('Query failed: ' . mysqli_error());
  $result_length = mysqli_num_rows($result);
  for($i = 1; $i <= $result_length; $i++)
  {    
